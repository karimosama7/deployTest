        ...
        public HomeworkSubmissionResponse submitHomework(Long studentId, Long homeworkId, String solutionUrl) {
                ...
                if (student.getParent() != null) {
                        notificationService.createNotification(
                                        ...
                                        student,
                                        "تم تسليم واجب",
                                        String.format("قام الطالب %s بتسليم الواجب: %s",
                                                        student.getUser().getFullName(), homework.getTitle()),
                                        Notification.NotificationType.HOMEWORK_SUBMISSION);
                }
        ...
        public HomeworkSubmissionResponse gradeSubmission(Long submissionId, BigDecimal grade, String feedback) {
                ...
                if (student.getParent() != null) {
                        notificationService.createNotification(
                                        ...
                                        student,
                                        "تم تصحيح الواجب",
                                        String.format("تم تصحيح واجب %s للطالب %s. الدرجة: %s",
                                                        submission.getHomework().getTitle(),
                                                        student.getUser().getFullName(),
                                                        grade.toString()),
                                        Notification.NotificationType.HOMEWORK_GRADED);
                }
