...
export const TeacherExamSolutionPage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchSolution = async () => {
            ...
            try {
                const data = await teacherService.getStudentExamSolution(Number(executionId));
                setSolution(data);
            } catch (err) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-2 text-gray-500 text-sm">
                ...
                <span onClick={() => navigate(-1)} className="cursor-pointer hover:text-indigo-600">النتائج</span>
                <ChevronRight className="w-4 h-4" />
                <span className="text-gray-900 font-medium">حل الطالب</span>
            </div>
